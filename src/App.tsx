...
function App() {
  ...
  const [action, setAction] = useState(options[1].value)
  ...
  const renderComponent = (c: String) => {
    switch(c){
      case 'get_account_info': return <Account/>
      case 'send_payment': return <SendPayment/>
      case 'time_held_escrow': return <TimeHeldEscrow/>
    }
  }
  ...
  return (
    <div className="App">
      <header className="App-header">
        <span className="App-title"><pre>xrpk v1</pre></span>
